...
class OilControl extends Control {
   ...
   */
  _setupCursor () {
    this._cursor = this._canvasControls.querySelector('#imglykit-oil-cursor')
   ...
   */
  _setupContainer () {
    this._container = this._canvasControls.querySelector('.imglykit-canvas-oil-container')
  ...
  /**
   * Sets up the slider used to change the oil size
   */
  _setupSlider () {
    if (!this._displayThickness) return
  ...
  /**
   * Sets up the color picker used to change the oil color
   */
  _setupColorPicker () {
    if (this._displayThickness) return
   ...
   */
  _redrawPath () {
    this._operation.renderOilCanvas(this._canvas, this._canvas)
  }
